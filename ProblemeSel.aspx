<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemeSel.aspx.cs" Inherits="INfoEducatie.Probleme" %>
        ...
        <div class="col-md-10 wb">
            <div class="row">
                ...
                <div style="padding: 50px;" class="col-sm-8">
                    <div class="row">
                        <h1 runat="server" id="quiztitle" class="text-center">Selectie Probleme</h1>
                        <br />
                        <br />
                        <div class="row" runat="server">
                            <form runat="server">
                                <div id="quiz" runat="server">
                                    <asp:LinkButton ID="refresh" runat="server" CssClass="btn btn-primary pull-right" OnClick="refresh_Click">
                                <span aria-hidden="true" class="glyphicon glyphicon-refresh"></span>
                                    </asp:LinkButton>
                                    <asp:DropDownList runat="server" AutoPostBack="true" CssClass="form-control" ID="probsel">
                                    </asp:DropDownList>
                                    <div runat="server" id="descr" style="background-color: aqua;" class="container brd">
                                    </div>
                                    <br />
                                    <asp:Button runat="server" Text="Start Problema" ID="start" CssClass="btn btn-primary pull-right" OnClick="start_Click" />
                                </div>
                            </form>
                        </div>
                    </div>
