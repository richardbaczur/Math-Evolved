<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rezultat.aspx.cs" Inherits="INfoEducatie.Rezultat" %>
                ...
                <div style="padding: 50px;" class="col-sm-8">
                    <div class="row">
                        ...
                        <div class="row" runat="server">
                            <form runat="server">
                                <h2 class="text-center" id="rez" runat="server"></h2>
                                <asp:Button runat="server" Text="Inapoi la meniul principal" CssClass="btn btn-success" ID="back" OnClick="back_Click"/>
                            </form>
                        </div>
                    </div>
                </div>
